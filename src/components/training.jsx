          ...
          <div className="container px-4 md:px-6 max-w-[1200px] mx-auto">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              {courses.map((course, index) => (
                <motion.div
                  key={course.title}
                  className="group relative overflow-hidden text-gray-300 rounded-lg border bg-card hover:shadow-xl transition-all duration-500 hover:-translate-y-2 opacity-0 animate-fade-in"
